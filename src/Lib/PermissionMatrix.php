...
namespace CipherguardTestData\Lib;
...
class PermissionMatrix
{
     ...
     * the CipherguardTestData.Base scenario.
     *
     * The access can be found in the csv file \plugins\CipherguardTestData\data\calculated_users_resources_permissions.csv
     * If you modify the access, report the changes in the :
     * - Google doc "Permissions Matrix" (https://docs.google.com/a/cipherguard.com/spreadsheets/d/1Yd5orUPZMKnzy-f4X8Nz5NXnX74fjFGJHAthVKCgoWc/edit?usp=sharing)
     * - Modify the permissions data task \plugins\CipherguardTestData\src\Shell\Task\Base\PermissionsDataTask
     *
