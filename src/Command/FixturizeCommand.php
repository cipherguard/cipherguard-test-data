 ...
 */
class FixturizeCommand extends CipherguardCommand
{
    ...
    public function execute(Arguments $args, ConsoleIo $io): ?int
    {
        ...
        $commands = Configure::read('CipherguardTestData.scenarios.' . $args->getArgument('scenario') . '.fixturize.shellTasks');
     ...
     * @param \CipherguardTestData\Lib\DataCommand $command Command
     * @return void
     */
